      ...
      <div className="w-300% flex justify-center mt-17.5 px-4">
        ...
        >
          ...
          <div className="text-center pb-4 px-4">
            <h4
              className="font-bold"
              style={{ color: "#151515", fontSize: "1.25rem" }}
            >
              xLeet <i className="fab fa-redhat" /> <br /> Welcome Back !
            </h4>
            ...
            >
                ...
                <div className="flex items-center justify-between border border-gray-300 rounded px-3 py-2 bg-white">
                  ...
                  <div className="flex flex-col items-center gap-0.5">
                    ...
                    <div
                      ...
                      style={{ color: "#0081ff", fontSize: "9px" }}
                    >
              ...
              <div className="mb-4">
                ...
                <p className="mt-4 text-sm" style={{ color: "#555555" }}>
                  ...
                  - Need an account?{" "}
                  <Link href="/register" style={{ color: "#0081ff" }}>
                    Register
                  </Link>
                </p>
              </div>
