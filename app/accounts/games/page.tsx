...
const accountData: AccountEntry[] = [
  {
    id: 1,
    websiteDomain: "steampowered.com",
    location: "WO",
    details: "| Status = Unverified | Balance = 0,--€ | Games = [Dota 2] | Total Games = 1 | Level = 0 | Years Badge = 2 | Badges = [Years of Service | One-Stop Shopper] | PRIME = NO",
    price: 5.00,
    seller: "seller142",
    source: "Pre Owned",
    dateCreated: "2022-10-01 14:42:42",
  },
  {
    id: 2,
    websiteDomain: "steamcommunity.com",
    location: "WO",
    details: "| Status = Unverified | Balance = $0.00 USD | Games = [Warframe | Warframe | Trove | Skald: Against the Black Priory - the Prologue] | Total Games = 3 | Level = 0 | Badges = [Steam Awards Nomination Committee 2016] | PRIME = NO",
    price: 2.50,
    seller: "seller144",
    source: "Pre Owned",
    dateCreated: "2023-02-03 17:21:22",
  },
  {
    id: 3,
    websiteDomain: "steampowered.com",
    location: "WO",
    details: "| Status = Unverified | Balance = 0,--€ | Games = [Lost Ark | Dota 2] | Total Games = 2 | Years Badge = 1 | Badges = [Years of Service | One-Stop Shopper] | Inventory Items = [Dota 2 (2)] | PRIME = NO",
    price: 5.00,
    seller: "seller142",
    source: "Pre Owned",
    dateCreated: "2022-10-01 14:45:57",
  },
  {
    id: 4,
    websiteDomain: "lumosity.com",
    location: "US",
    details: "| next_billing_date = 🔥2023-12-21🔥 | balance = 0.0 | 🔥 payment_type = visa 🔥 | last_four = 8402 | plan = 46🔥🔥 Lumosity is a brain-training program with more than 50 games designed by neuroscientists to improve cognitive skills by practicing them over and over again with games. Lumosity games are derivations of tasks commonly used in cognitive psychology. 🔥",
    price: 30.00,
    seller: "seller49",
    source: "Pre Owned",
    dateCreated: "2023-02-04 21:29:37",
  },
];
...
const SourceBadge = ({ source }: { source: "Pre Owned" | "created" }) =>
  source === "created" ? (
    <span className="flex items-center gap-1.5 text-xs font-medium text-blue-600">
      <span className="w-4 h-4 rounded-full bg-blue-500 text-white flex items-center justify-center text-[9px] shrink-0 font-bold">+</span>
      created
    </span>
  ) : (
      ...
      <main className="flex-1 w-full px-4 py-6">
        ...
        <div className="bg-[#d1ecf1] border border-[#bee5eb] text-[#0c5460] rounded px-4 py-3 mb-5 text-sm">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>There is 32 Accounts [Games] Available .</li>
          </ul>
        </div>
            ...
            <tbody>
              {filtered.map((row, i) => (
                ...
                >
                  ...
                  <td className="px-3 py-2.5 text-xs text-gray-700 max-w-[300px] leading-relaxed">{row.details}</td>
