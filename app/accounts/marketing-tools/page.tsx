...
const accountData: AccountEntry[] = [
  {
    id: 1,
    websiteDomain: "www.strato.de",
    location: "WO",
    details:
      "FRESH CRACKED 🍓 STRATO NL PANEL 🍓 PAYEMENT METHODE SAVED 🍓 CAN CREATE SMTPS FOR GOOD LIMITS 💌INBOX💌",
    price: 119.99,
    seller: "seller53",
    source: "Pre Owned",
    dateCreated: "2025-03-11 00:37:15",
  },
  {
    id: 2,
    websiteDomain: "www.strato.com",
    location: "WO",
    details:
      "FRESH CRACKED 🍓 STRATO NL PANEL 🍓 PAYEMENT METHODE SAVED 🍓 CAN CREATE SMTPS FOR GOOD LIMITS 💌INBOX💌",
    price: 129.99,
    seller: "seller53",
    source: "Pre Owned",
    dateCreated: "2025-03-11 00:37:39",
  },
  {
    id: 3,
    websiteDomain: "www.strato.de",
    location: "WO",
    details:
      "FRESH CRACKED 🍓 STRATO DE PANEL 🍓 DOMAIN HTTPS💌 PAYEMENT METHODE SAVED 🍓 CAN CREATE SMTPS FOR GOOD LIMITS 💌INBOX💌",
    price: 99.99,
    seller: "seller53",
    source: "Pre Owned",
    dateCreated: "2025-03-18 01:21:03",
  },
  {
    id: 4,
    websiteDomain: "login.ionos.com",
    location: "WO",
    details:
      "🔥🔥 FRESH cracked 🔥🔥 IONOS PORTAL🔥 🔥WORKING 🔥🔥DOMAIN SSL🔥🔥 PAYEMENTS METHOD SAVED🔥 🔥 CAN CREATE WEBMAILS/SMTP AND DOMAIN🔥 🔥",
    price: 129.99,
    seller: "seller53",
    source: "Pre Owned",
    dateCreated: "2025-04-11 16:19:23",
  },
  {
    id: 5,
    websiteDomain: "www.strato.se",
    location: "WO",
    details:
      "FRESH CRACKED 🍓 STRATO SE PANEL 🍓 DOMAIN HTTPS💌 PAYEMENT METHODE SAVED 🍓 CAN CREATE SMTPS FOR GOOD LIMITS 💌INBOX💌",
    price: 99.99,
    seller: "seller53",
    source: "Pre Owned",
    dateCreated: "2025-03-18 01:21:34",
  },
  {
    id: 6,
    websiteDomain: "www.strato.de",
    location: "WO",
    details:
      "✅Fresh Cracked STRATO Panel 🔥Domaines HTTPS ✅SMTP work Inbox 🔥✅Strong Send",
    price: 79.81,
    seller: "seller92",
    source: "Pre Owned",
    dateCreated: "2025-05-13 00:33:33",
  },
  {
    id: 7,
    websiteDomain: "1und1.de",
    location: "WO",
    details:
      "💌Fresh Cracked💌1und1 Control Panel💌Premium💌Payment method saved in the account💌Able to create phone numbers to make voice calls and sms💌",
    price: 119.99,
    seller: "seller53",
    source: "Pre Owned",
    dateCreated: "2024-09-01 22:49:05",
  },
];
      ...
      <main className="flex-1 w-full px-4 py-6">
        ...
        <div className="bg-[#d1ecf1] border border-[#bee5eb] text-[#0c5460] rounded px-4 py-3 mb-5 text-sm">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>There is 11 Accounts [Marketing Tools] Available .</li>
          </ul>
        </div>
