...
const leadData: LeadEntry[] = [
  {
    id: 1,
    location: "WO",
    description: "2.5M Instagram logs best for combo attack more 70% hint",
    niche: "instagram.con",
    website: "instagram.con",
    provider: "instagram",
    password: "No",
    emailsNumber: "2.5M",
    price: 2000.00,
    seller: "seller30",
    dateCreated: "2022-10-15 18:51:32",
  },
];
...
export default function SocialMediaDataPage() {
  const [description, setDescription] = useState("");
  const [provider, setProvider] = useState("");
  const [type, setType] = useState("social-media-data");
      ...
      <main className="flex-1 w-full px-4 py-6">
        ...
        <div className="bg-[#d1ecf1] border border-[#bee5eb] text-[#0c5460] rounded px-4 py-3 mb-5 text-sm">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>There is 1 Social Media Data Lists Available.</li>
          </ul>
        </div>
