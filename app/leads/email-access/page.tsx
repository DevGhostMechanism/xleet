...
const leadData: LeadEntry[] = [
  {
    id: 1,
    location: "CA",
    description: "✅🔥7Fresh HQ Dumbing Email Access Canada((New And Freshly Combo Access 2026))(Exclusive For Our Buyers) [Full Private - Buy fast before them die] $🔥",
    niche: "N\\A",
    website: "Fresh Mail Access $🔥",
    provider: "sympatico.ca+videotron.ca",
    password: "Yes",
    emailsNumber: "7",
    price: 28.00,
    seller: "seller71",
    dateCreated: "2026-01-06 18:47:02",
  },
  {
    id: 2,
    location: "JP",
    description: "✅🔥50 Fresh @biglobe.ne.jp Email Access 100% [JAPAN] ((New And Freshly Combo Access 2025))[Buy fast before them die] $😅🚀✈️",
    niche: "N\\A",
    website: "Fresh Combo Access $🔥",
    provider: "@biglobe.ne.jp",
    password: "Yes",
    emailsNumber: "50",
    price: 20.00,
    seller: "seller98",
    dateCreated: "2025-09-26 02:25:16",
  },
  {
    id: 3,
    location: "WO",
    description: "✅🔥$ 10 zimbra mail access 100% mixed country ✅(login+email+pass)✅((New And Freshly Combo Access ))✅[Buy fast before them die](NOT SMTP)",
    niche: "N\\A",
    website: "Fresh Combo Access $🔥😅✈️",
    provider: "$ zimbra webmail mail access✈️",
    password: "Yes",
    emailsNumber: "10",
    price: 20.00,
    seller: "seller98",
    dateCreated: "2026-02-18 17:53:26",
  },
  {
    id: 4,
    location: "US",
    description: "✅🔥25 Fresh USA Email Access 100% [United States] ((New And Freshly Combo Access 2025))[Buy fast before them die] $🔥🚀",
    niche: "N\\A",
    website: "Fresh Mail Access $🔥",
    ...
    price: 35.00,
    seller: "seller71",
    dateCreated: "2025-11-14 09:12:44",
  },
  {
    id: 5,
    location: "GB",
    description: "✅🔥15 Fresh UK Email Access 100% [United Kingdom] ((New And Freshly Combo Access 2025))[Buy fast before them die] $🔥",
    niche: "N\\A",
    website: "Fresh Combo Access $🔥",
    provider: "btinternet.com+sky.com",
    password: "Yes",
    emailsNumber: "15",
    price: 22.00,
    seller: "seller98",
    dateCreated: "2025-12-03 15:30:11",
  },
  {
    id: 6,
    location: "DE",
    description: "✅🔥30 Fresh Germany Email Access 100% [GERMANY] ((New And Freshly Combo Access 2025))[Buy fast before them die] $😅🚀",
    niche: "N\\A",
    website: "Fresh Mail Access $🔥",
    provider: "web.de+gmx.de",
    password: "Yes",
    emailsNumber: "30",
    price: 30.00,
    seller: "seller71",
    dateCreated: "2025-10-22 08:45:33",
  },
];
...
export default function EmailAccessPage() {
  ...
  const [type, setType] = useState("email-access");
      ...
      <main className="flex-1 w-full px-4 py-6">
        ...
        <div className="bg-[#d1ecf1] border border-[#bee5eb] text-[#0c5460] rounded px-4 py-3 mb-5 text-sm">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>There is 1442 Email Access Lists Available.</li>
          </ul>
        </div>
          ...
          <div className="flex flex-wrap items-end gap-x-4 gap-y-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              >
                ...
                <option value="seller98">seller98</option>
              </select>
            </div>
            <div className="flex flex-col gap-1">
