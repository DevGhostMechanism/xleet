...
const leadData: LeadEntry[] = [
  {
    id: 1,
    location: "CL",
    description: "✅🔥11.5K Fresh HQ Dumbing Email List Private and Golden Database [with SQL injection Link- not checked] $ 🔥",
    niche: "N/A",
    website: "Fresh Leads $ 🔥",
    provider: "Mix $ 🔥",
    password: "No",
    ...
    price: 26.00,
    seller: "seller71",
    dateCreated: "2022-07-15 05:10:40",
  },
  {
    id: 2,
    location: "ES",
    description: "✅🔥9K Fresh HQ Dumbing Email List Private and High Quality [with SQL injection Link- not checked] $ 🔥",
    niche: "N/A",
    website: "Fresh Leads $ 🔥",
    provider: "Mix $ 🔥",
    password: "No",
    ...
    price: 26.00,
    seller: "seller71",
    dateCreated: "2022-07-02 15:23:07",
  },
  {
    id: 3,
    location: "US",
    description: "✅🔥2.3K Super HQ Dumbing Email List Morganstanley.Com Banking 100% Private and High Quality((New And Freshly Leads Banking 2023)) [with SQL injection Link- not checked] $ 🔥",
    niche: "N/A",
    website: "Fresh Leads✅🔥",
    provider: "Morganstanley.Com Banking",
    password: "No",
    emailsNumber: "2.3K",
    price: 36.00,
    seller: "seller71",
    dateCreated: "2023-04-29 13:52:39",
  },
  {
    id: 4,
    location: "IR",
    description: "🔥🔥10.6K Super HQ Dumbing Email List Private and Best Leads(VIP) [with SQL injection Link- not checked] $ 🔥",
    niche: "N/A",
    website: "Fresh Leads $ 🔥",
    provider: "Mix $ 🔥",
    password: "No",
    ...
    price: 36.00,
    seller: "seller71",
    dateCreated: "2022-08-15 07:21:54",
  },
];
...
export default function EmailOnlyPage() {
  ...
  const [type, setType] = useState("email-only");
      ...
      <main className="flex-1 w-full px-4 py-6">
        ...
        <div className="bg-[#d1ecf1] border border-[#bee5eb] text-[#0c5460] rounded px-4 py-3 mb-5 text-sm">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>There is 17118 Email Only Lists Available.</li>
          </ul>
        </div>
