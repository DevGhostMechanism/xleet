...
const leadData: LeadEntry[] = [
  {
    id: 1,
    location: "TW",
    description: "✅🔥2.3K Fresh HQ Dumbing Combo Email List Twian [with SQL injection- not checked] $🔥",
    niche: "N\\A",
    website: "Fresh Leads $🔥",
    provider: "Email Combo List🚀😅",
    password: "No",
    emailsNumber: "2.3K",
    price: 14.00,
    seller: "seller71",
    dateCreated: "2022-03-11 11:21:41",
  },
  {
    id: 2,
    location: "US",
    description: "✅🔥38.5K Fresh HQ Dumbing Combo Email List Private [with SQL injection- not checked] $🔥",
    niche: "N\\A",
    website: "Fresh Leads $🔥",
    provider: "Email Combo List✅🔥",
    password: "No",
    ...
    price: 50.00,
    seller: "seller71",
    dateCreated: "2022-03-15 17:30:32",
  },
  {
    id: 3,
    location: "DE",
    description: "✅🔥81K Fresh HQ Dumbing Combo Email Hash from Database ****** this month(2022) [with SQL injection- not checked]😅🔥",
    niche: "N\\A",
    website: "Fresh Combo List $🔥",
    provider: "Email Combo hash✅🔥",
    password: "No",
    emailsNumber: "81.0K",
    price: 100.00,
    seller: "seller71",
    dateCreated: "2022-05-06 14:38:52",
  },
  {
    id: 4,
    location: "BR",
    description: "17.7K @Brazil Fresh Super HQ Combo Email:Hash [with SQL Link Infected + Not checked]✅",
    niche: "N\\A",
    website: "w********go.com.br",
    provider: "Mix",
    password: "No",
    ...
    price: 23.00,
    seller: "seller100",
    dateCreated: "2025-11-07 23:07:36",
  },
  {
    id: 5,
    location: "WO",
    description: "9.9K Fresh Super HQ Combo Email:Hash with SQL Link 🚀",
    niche: "N\\A",
    ...
    price: 12.00,
    seller: "seller100",
    dateCreated: "2025-11-08 00:42:53",
  },
];
...
export default function ComboEmailHashPage() {
  const [description, setDescription] = useState("");
  const [provider, setProvider] = useState("");
  const [type, setType] = useState("combo-email-hash");
      ...
      <main className="flex-1 w-full px-4 py-6">
        ...
        <div className="bg-[#d1ecf1] border border-[#bee5eb] text-[#0c5460] rounded px-4 py-3 mb-5 text-sm">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>There is 1194 Combo Email:Hash Lists Available.</li>
          </ul>
        </div>
