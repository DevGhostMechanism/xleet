...
const leadData: LeadEntry[] = [
  {
    id: 1,
    location: "FR",
    description: "✅🔥8K Super UHQ Combo Email List Extracted From ****** leboncoin.fr Database (2025)Target ***** leboncoin.fr And Other Sites[Private-not checked]Ready to Rezults $ 🔥",
    niche: "N/A",
    website: "Fresh Combo List $ 🔥",
    provider: "leboncoin.fr Database",
    password: "Yes",
    emailsNumber: "8.0K",
    price: 34.00,
    seller: "seller71",
    dateCreated: "2025-07-09 14:37:11",
  },
  {
    id: 2,
    location: "WO",
    description: "✅🔥5.3K Super UHQ Combo Email List Extracted From ****** Ovh.com Database (2025)Target ***** Ovh.com And Other Sites[Private-not checked]Ready to Rezults $ 🔥",
    niche: "N/A",
    website: "Fresh Combo List $ 🔥",
    provider: "ovh database",
    password: "Yes",
    emailsNumber: "5.3K",
    price: 26.00,
    seller: "seller71",
    dateCreated: "2025-07-26 19:33:28",
  },
  {
    id: 3,
    location: "WO",
    description: "✅🔥14K Super UHQ Combo Email List Extracted From ****** shutterstock.com Database(2025)Target **** shutterstock.com And Other Sites[Private-not checked]Ready to Rezults $ 🔥",
    niche: "N/A",
    website: "Fresh Combo List $ 🔥",
    provider: "shutterstock database",
    password: "Yes",
    emailsNumber: "14.0K",
    price: 34.00,
    seller: "seller71",
    dateCreated: "2024-12-22 16:57:09",
  },
];
...
export default function ComboEmailPasswordPage() {
  const [description, setDescription] = useState("");
  const [provider, setProvider] = useState("");
  const [type, setType] = useState("combo-email-password");
      ...
      <main className="flex-1 w-full px-4 py-6">
        ...
        <div className="bg-[#d1ecf1] border border-[#bee5eb] text-[#0c5460] rounded px-4 py-3 mb-5 text-sm">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>There is 9993 Combo Email:Password Lists Available.</li>
          </ul>
        </div>
