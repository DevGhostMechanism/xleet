...
const webmailData: WebmailEntry[] = [
  {
    ...
    location: "CA",
    source: "Pre Owned",
    website: "northstarventures.ca",
    hosting: "AWS Global Accelerator (GLOBAL)",
    price: 27.0,
    seller: "seller55",
    type: "Office Godaddy Webmail",
    niche: "Wealth - Money",
    dateCreated: "2026-05-30 08:14:22",
  },
  {
    id: 2,
    location: "US",
    source: "Pre Owned",
    website: "premiumfinancials.com",
    hosting: "GoDaddy.com, LLC",
    price: 24.0,
    seller: "seller141",
    type: "Office Godaddy Webmail",
    niche: "Other",
    dateCreated: "2026-04-11 17:45:09",
  },
  {
    id: 3,
    location: "GB",
    source: "Pre Owned",
    website: "eliteofficeuk.co.uk",
    hosting: "AWS Global Accelerator (GLOBAL)",
    price: 22.0,
    seller: "seller18",
    type: "Office Godaddy Webmail",
    niche: "Other",
    dateCreated: "2026-05-07 11:22:54",
  },
  {
    id: 4,
    location: "FR",
    source: "Pre Owned",
    website: "strategyplus.fr",
    hosting: "GD MASS Network",
    price: 31.0,
    seller: "seller52",
    type: "Office Godaddy Webmail",
    niche: "Wealth - Money",
    dateCreated: "2026-03-19 06:58:41",
  },
  {
    id: 5,
    location: "CA",
    source: "Pre Owned",
    website: "alphadigitalca.com",
    hosting: "AWS Global Accelerator (GLOBAL)",
    price: 20.2,
    seller: "seller18",
    type: "Office Godaddy Webmail",
    niche: "Other",
    dateCreated: "2026-01-15 09:33:17",
  },
  {
    id: 6,
    location: "AU",
    source: "Pre Owned",
    website: "businessoffice.com.au",
    hosting: "GoDaddy.com, LLC",
    price: 21.0,
    seller: "seller46",
    type: "Office Godaddy Webmail",
    niche: "Other",
    dateCreated: "2026-04-02 14:10:38",
  },
  {
    id: 7,
    location: "US",
    source: "Pre Owned",
    website: "corpinnovate.com",
    hosting: "AWS Global Accelerator (GLOBAL)",
    price: 20.2,
    seller: "seller55",
    type: "Office Godaddy Webmail",
    niche: "Other",
    dateCreated: "2026-01-08 03:47:55",
  },
  {
    id: 8,
    location: "DE",
    source: "Pre Owned",
    website: "officepremium.de",
    hosting: "GD MASS Network",
    price: 26.0,
    seller: "seller52",
    type: "Office Godaddy Webmail",
    niche: "Wealth - Money",
    dateCreated: "2026-02-25 20:04:13",
  },
  {
    id: 9,
    location: "NL",
    source: "Pre Owned",
    website: "dutchbizoffice.nl",
    hosting: "AWS Global Accelerator (GLOBAL)",
    price: 19.0,
    seller: "seller141",
    type: "Office Godaddy Webmail",
    niche: "Other",
    dateCreated: "2026-05-01 07:29:46",
  },
  {
    id: 10,
    location: "IE",
    source: "Pre Owned",
    website: "irishbusiness365.ie",
    hosting: "GoDaddy.com, LLC",
    price: 23.0,
    seller: "seller46",
    type: "Office Godaddy Webmail",
    niche: "Other",
    dateCreated: "2026-04-17 18:55:30",
  },
];
...
export default function OfficeGodaddyWebmailPage() {
  const [hosting, setHosting] = useState("");
  const [website, setWebsite] = useState("");
  const [country, setCountry] = useState("all");
  const [type, setType] = useState("Office Godaddy Webmail");
