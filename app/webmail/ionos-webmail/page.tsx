...
const webmailData: WebmailEntry[] = [
  {
    ...
    location: "DE",
    source: "Pre Owned",
    website: "kfz-erhardt.de",
    hosting: "Ionos Inf",
    price: 10.0,
    seller: "seller64",
    type: "Ionos Webmail",
    niche: "Other",
    dateCreated: "2026-05-12 18:50:02",
  },
  {
    id: 2,
    location: "DE",
    source: "Pre Owned",
    website: "language-academy-hamburg.de",
    hosting: "Ionos Inf",
    price: 10.0,
    seller: "seller64",
    type: "Ionos Webmail",
    niche: "Other",
    dateCreated: "2026-05-12 18:58:34",
  },
  {
    id: 3,
    location: "WO",
    source: "Pre Owned",
    website: "vglobaltech.com",
    hosting: "Sucuri",
    price: 9.99,
    seller: "seller52",
    type: "Ionos Webmail",
    niche: "Other",
    dateCreated: "2026-05-31 00:35:08",
  },
  {
    id: 4,
    location: "GB",
    source: "Pre Owned",
    website: "cleaningnationwide.co.uk",
    hosting: "Ionos Inf",
    price: 15.0,
    seller: "seller85",
    type: "Ionos Webmail",
    niche: "Other",
    dateCreated: "2026-04-20 20:33:30",
  },
  {
    id: 5,
    location: "DE",
    ...
    type: "Ionos Webmail",
    niche: "Other",
    dateCreated: "2026-05-07 16:09:55",
  },
  {
    id: 6,
    location: "DE",
    source: "Pre Owned",
    website: "privatpraxis-ulrikemehmood.de",
    hosting: "Ionos Inf",
    price: 10.0,
    seller: "seller64",
    type: "Ionos Webmail",
    niche: "Other",
    dateCreated: "2026-05-12 18:53:55",
  },
  {
    id: 7,
    location: "GB",
    source: "Pre Owned",
    website: "advwebitaly.it",
    hosting: "Ionos Inf",
    price: 15.0,
    seller: "seller161",
    type: "Ionos Webmail",
    niche: "Other",
    dateCreated: "2026-05-22 18:53:33",
  },
  {
    id: 8,
    location: "ES",
    source: "Pre Owned",
    website: "negociodigital.es",
    hosting: "Ionos Inf",
    price: 12.0,
    seller: "seller64",
    type: "Ionos Webmail",
    niche: "Other",
    dateCreated: "2026-04-18 09:41:17",
  },
  {
    id: 9,
    location: "FR",
    source: "Pre Owned",
    website: "agencewebparis.fr",
    hosting: "Ionos Inf",
    price: 12.0,
    seller: "seller85",
    type: "Ionos Webmail",
    niche: "Other",
    dateCreated: "2026-03-31 14:27:44",
  },
  {
    id: 10,
    location: "AT",
    source: "Pre Owned",
    website: "wienerservices.at",
    hosting: "Ionos Inf",
    price: 10.0,
    seller: "seller64",
    type: "Ionos Webmail",
    niche: "Other",
    dateCreated: "2026-05-03 07:12:59",
  },
];
...
export default function IonosWebmailPage() {
  const [hosting, setHosting] = useState("");
  const [website, setWebsite] = useState("");
  const [country, setCountry] = useState("all");
  const [type, setType] = useState("Ionos Webmail");
      ...
      <main className="flex-1 w-full px-4 py-6">
        ...
        <div className="bg-[#d1ecf1] border border-[#bee5eb] text-[#0c5460] rounded px-4 py-3 mb-5 text-sm">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>There is 715326 Webmail Available.</li>
          </ul>
        </div>
          ...
          <div className="flex flex-wrap items-end gap-x-4 gap-y-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              >
                ...
                <option value="seller85">seller85</option>
                <option value="seller161">seller161</option>
              </select>
            </div>
            <div className="flex flex-col gap-1">
